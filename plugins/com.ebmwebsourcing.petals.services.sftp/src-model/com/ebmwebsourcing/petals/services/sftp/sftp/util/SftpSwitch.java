 ...
 * @generated
 */
public class SftpSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SftpPackage.SFTP_PROVIDES: {
				SftpProvides sftpProvides = (SftpProvides)theEObject;
				T result = caseSftpProvides(sftpProvides);
				if (result == null) result = caseProvides(sftpProvides);
				if (result == null) result = caseAbstractEndpoint(sftpProvides);
				if (result == null) result = caseAbstractExtensibleElement(sftpProvides);
	 ...
	 * @generated
	 */
	public T caseSftpProvides(SftpProvides object) {
		return null;
	}
