 ...
 * @generated
 */
public class JbiSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JbiPackage.ABSTRACT_EXTENSIBLE_ELEMENT: {
				AbstractExtensibleElement abstractExtensibleElement = (AbstractExtensibleElement)theEObject;
				T result = caseAbstractExtensibleElement(abstractExtensibleElement);
			...
			case JbiPackage.COMPONENT: {
				...
				if (result == null) result = caseAbstractExtensibleElement(component);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JbiPackage.CONNECTIONS: {
				...
				if (result == null) result = caseAbstractExtensibleElement(connections);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JbiPackage.IDENTIFICATION: {
				...
				if (result == null) result = caseAbstractExtensibleElement(identification);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JbiPackage.JBI: {
			...
			case JbiPackage.SERVICES: {
				...
				if (result == null) result = caseAbstractExtensibleElement(services);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JbiPackage.ABSTRACT_ENDPOINT: {
				AbstractEndpoint abstractEndpoint = (AbstractEndpoint)theEObject;
				T result = caseAbstractEndpoint(abstractEndpoint);
				if (result == null) result = caseAbstractExtensibleElement(abstractEndpoint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case JbiPackage.SERVICE_ASSEMBLY: {
				...
				if (result == null) result = caseAbstractExtensibleElement(serviceAssembly);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JbiPackage.SERVICE_UNIT: {
				...
				if (result == null) result = caseAbstractExtensibleElement(serviceUnit);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
