...
public class JbiProvidePage extends JbiAbstractPage {
	...
	public String getDescription() {
		...
		if( getWizard().getWizardHandler().getComponentVersionDescription().isBc())
		...
		endpointAutoGenerated.addSelectionListener( new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if( button.getSelection()) {	// button is checked
					...
					getNewlyCreatedEndpoint().setEndpointName( getWizard().getWizardHandler().getComponentVersionDescription().getAutoGeneratedEndpointValue());
				}
