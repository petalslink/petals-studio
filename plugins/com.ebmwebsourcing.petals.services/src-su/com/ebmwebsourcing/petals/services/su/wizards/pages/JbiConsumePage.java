	...
	public void createCustomControls( Composite container ) {
		...
		this.edptText.addModifyListener( new ModifyListener() {
			...
			public void modifyText( ModifyEvent e ) {
				...
				String autogenValue = getWizard().getWizardHandler().getComponentVersionDescription().getAutoGeneratedEndpointValue();
		...
		this.helpTooltip = new FixedShellTooltip( getShell(), true, 90 ) {
			...
			public void populateTooltip( Composite parent ) {
				...
				sb.append( "The " + getWizard().getWizardHandler().getComponentVersionDescription().getComponentAlias() + " component can only invoke (consume) services with the " );
				// TODO: fix this
