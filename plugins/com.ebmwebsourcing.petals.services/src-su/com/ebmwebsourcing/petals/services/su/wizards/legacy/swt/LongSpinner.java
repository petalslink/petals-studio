 ...
 */
public class LongSpinner extends NumericSpinner<Long> {
	 ...
	 */
	public LongSpinner(
				Long initialValue, Composite parent,
	 ...
	 */
	@Override
	protected Long divide( int value, double divider ) {
	 ...
	 */
	@Override
	protected Number multiply( Long value, double multiplier ) {
