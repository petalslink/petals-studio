 ...
 */
public class SeConsumeJbiPage extends BcConsumeJbiPage {
	 ...
	 */
	public SeConsumeJbiPage( String suType, String suTypeVersion ) {
		super( suType, suTypeVersion );

		setDescription( "Define the JBI properties of the service to provide." );
		this.isConsume = true;
	}
