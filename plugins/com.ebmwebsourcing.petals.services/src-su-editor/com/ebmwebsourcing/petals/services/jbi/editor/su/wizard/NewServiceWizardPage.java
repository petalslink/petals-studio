...
public class NewServiceWizardPage extends WizardPage implements IWizardPage {
	...
	public void createControl(Composite parent) {
		...
		lblServiceMode.setText("Service Mode");
		
		final Button provideButton = new Button(composite, SWT.RADIO);
		provideButton.setText("a PROVIDE imports an external system or application as a service into the bus");
		new Label(composite, SWT.NONE);
		
		final Button consumeButton = new Button(composite, SWT.RADIO);
		consumeButton.setText("a CONSUME exposes a service from inside the bus to another system or application");
		
		Label lblAvailableServices = new Label(control, SWT.NONE);
		lblAvailableServices.setText("Select a component for your service");
