...
public class ServiceRefImpl extends ExtensibleElementImpl implements ServiceRef {
	...
	public void setReferenceScheme(String newReferenceScheme) {
		String oldReferenceScheme = this.referenceScheme;
		if (!this.isReconciling) {
			ReconciliationHelper.replaceAttribute(this,
					BPELConstants.AT_REFERENCE_SCHEME, newReferenceScheme);
		}
		this.referenceScheme = newReferenceScheme;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BPELPackage.SERVICE_REF__REFERENCE_SCHEME,
					oldReferenceScheme, this.referenceScheme));
	}
	...
	public void setValue(Object newValue) {
		...
		this.value = newValue;
		if (!this.isReconciling && oldValue != newValue) {
			this.valueNode = ReconciliationHelper.replaceValue(this, this.valueNode,
					newValue);
		}
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BPELPackage.SERVICE_REF__VALUE, oldValue, this.value));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case BPELPackage.SERVICE_REF__REFERENCE_SCHEME:
			return REFERENCE_SCHEME_EDEFAULT == null ? this.referenceScheme != null
					: !REFERENCE_SCHEME_EDEFAULT.equals(this.referenceScheme);
		case BPELPackage.SERVICE_REF__VALUE:
			return VALUE_EDEFAULT == null ? this.value != null : !VALUE_EDEFAULT
					.equals(this.value);
		}
	...
	public String toString() {
		...
		result.append(this.referenceScheme);
