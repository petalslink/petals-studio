 ...
 */
package com.ebmwebsourcing.petals.services.eip.eip.util;
...
public class EipSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EipPackage.EIP_PROVIDES: {
				EipProvides eipProvides = (EipProvides)theEObject;
				T result = caseEipProvides(eipProvides);
				if (result == null) result = caseProvides(eipProvides);
				if (result == null) result = caseAbstractEndpoint(eipProvides);
				if (result == null) result = caseAbstractExtensibleElement(eipProvides);
	 ...
	 * @generated
	 */
	public T caseEipProvides(EipProvides object) {
		return null;
	}
