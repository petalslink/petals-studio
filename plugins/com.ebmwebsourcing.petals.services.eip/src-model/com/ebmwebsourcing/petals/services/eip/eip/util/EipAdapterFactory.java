...
public class EipAdapterFactory extends AdapterFactoryImpl {
	...
	protected EipSwitch<Adapter> modelSwitch =
		new EipSwitch<Adapter>() {
			@Override
			public Adapter caseEipProvides(EipProvides object) {
				return createEipProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.eip.eip.EipProvides <em>Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEipProvidesAdapter() {
		return null;
	}
