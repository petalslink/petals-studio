 ...
 * @generated
 */
public class XsltAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected XsltSwitch<Adapter> modelSwitch =
		new XsltSwitch<Adapter>() {
			@Override
			public Adapter caseXSLTProvides(XSLTProvides object) {
				return createXSLTProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.studio.services.xslt.xslt.XSLTProvides <em>XSLT Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXSLTProvidesAdapter() {
		return null;
	}
