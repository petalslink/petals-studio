 ...
 */
package com.ebmwebsourcing.petals.studio.services.xslt.xslt.util;
 ...
 * @generated
 */
public class XsltSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static XsltPackage modelPackage;
	...
	public XsltSwitch() {
		if (modelPackage == null) {
			modelPackage = XsltPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XsltPackage.XSLT_PROVIDES: {
				XSLTProvides xsltProvides = (XSLTProvides)theEObject;
				T result = caseXSLTProvides(xsltProvides);
				if (result == null) result = caseProvides(xsltProvides);
				if (result == null) result = caseAbstractEndpoint(xsltProvides);
				if (result == null) result = caseAbstractExtensibleElement(xsltProvides);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>XSLT Provides</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>XSLT Provides</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseXSLTProvides(XSLTProvides object) {
		return null;
	}
