 ...
 */
public class PetalsXsltPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.xslt";

	// The shared instance
	private static PetalsXsltPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsXsltPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsXsltPlugin getDefault() {
		return plugin;
	}
