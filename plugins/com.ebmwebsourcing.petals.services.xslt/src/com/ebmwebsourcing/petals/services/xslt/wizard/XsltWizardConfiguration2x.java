 ...
 */
public class XsltWizardConfiguration2x extends WizardConfiguration {

	/**
	 * The constructor which overrides the configuration values.
	 */
	public XsltWizardConfiguration2x () {

		this.wizardSettings.put( SettingConstants.WSDL_SHOW, "false" );
		this.wizardSettings.put( SettingConstants.ITF_NAME_VALUE, "XsltInterface" );
		...
		this.wizardSettings.put( SettingConstants.ITF_NS_VALUE, "http://petals.ow2.org/components/xslt/version-2" );
		this.wizardSettings.put( SettingConstants.SRV_NS_VALUE, "http://petals.ow2.org/components/xslt/version-2" );
	}
}
