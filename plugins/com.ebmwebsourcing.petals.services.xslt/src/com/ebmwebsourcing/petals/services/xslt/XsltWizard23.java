 ...
 */
public class XsltWizard23 extends ComponentWizardHandler {
	...
	public void predefineJbiValues( AbstractEndpoint ae ) {
		...
		if( isServiceProvider()) {
			ae.setInterfaceName( new QName( "http://petals.ow2.org/components/xslt/version-2", "XsltInterface" ));
			ae.setServiceName( new QName( "http://petals.ow2.org/components/xslt/version-2", "change-it" ));
		}
	}
...
//			createFile( wsdlFile, new XsltService23().generate( abstractEndpoint ), monitor );
//		}
