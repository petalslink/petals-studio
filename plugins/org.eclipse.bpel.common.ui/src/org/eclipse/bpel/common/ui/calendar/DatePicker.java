...
public class DatePicker extends Composite {
	...
	private void createControls() {
		...
		this.dateDisplayField = new Text(this, SWT.BORDER | SWT.SINGLE);
		this.dateDisplayField.setText(getDateDisplayString(new Date()));
		GridData gd = new GridData();
		gd.grabExcessHorizontalSpace = true;
		gd.horizontalAlignment = GridData.FILL;
		this.dateDisplayField.setLayoutData(gd);

		this.showCalendarButton = new Button(this, SWT.PUSH);
		this.showCalendarButton.setText(Messages.DatePicker_button_text);
		gd = new GridData();
		gd.grabExcessHorizontalSpace = false;
		gd.horizontalAlignment = GridData.BEGINNING;
		this.showCalendarButton.setLayoutData(gd);
	}

	private void hookControlListeners() {
		this.showCalendarButton.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				setDate(CalendarPopup.openCalendarPopup(DatePicker.this.dateDisplayField, getDate()));
			}
		});
	}
