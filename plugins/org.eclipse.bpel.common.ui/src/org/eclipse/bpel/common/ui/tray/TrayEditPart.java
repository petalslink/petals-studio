...
public abstract class TrayEditPart extends AbstractGraphicalEditPart {
	...
	public void activate() {
		...
		modelObject.eAdapters().add(this.adapter);
	}
	...
	public void deactivate() {
		super.deactivate();
		EObject modelObject = (EObject)getModel();
		modelObject.eAdapters().remove(this.adapter);
	}
	...
	protected void performDirectEdit(DirectEditRequest request) {
		...
		if(this.directEditManager == null) {
			this.directEditManager = new TrayCategoryEntryEditPartDirectEditManager(this,
