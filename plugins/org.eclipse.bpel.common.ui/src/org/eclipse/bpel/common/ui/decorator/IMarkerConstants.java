...
public interface IMarkerConstants {
	...
	public static final Integer CENTER = PositionConstants.CENTER;
	public static final Integer TOP = PositionConstants.TOP;
	public static final Integer BOTTOM = PositionConstants.BOTTOM;
	public static final Integer LEFT = PositionConstants.LEFT;
	public static final Integer RIGHT = PositionConstants.RIGHT;
	public static final Integer TOP_LEFT = PositionConstants.TOP | PositionConstants.LEFT;
	public static final Integer TOP_RIGHT = PositionConstants.TOP | PositionConstants.RIGHT;
	public static final Integer BOTTOM_LEFT = PositionConstants.BOTTOM | PositionConstants.LEFT;
	public static final Integer BOTTOM_RIGHT = PositionConstants.BOTTOM | PositionConstants.RIGHT;
