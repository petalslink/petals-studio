 ...
 */
public class JbiFormEditorPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.jbi.editor.form"; //$NON-NLS-1$

	// The shared instance
	private static JbiFormEditorPlugin plugin;
	
	/**
	 * The constructor
	 */
	public JbiFormEditorPlugin() {
	}
	 ...
	 */
	public static JbiFormEditorPlugin getDefault() {
		return plugin;
	}
