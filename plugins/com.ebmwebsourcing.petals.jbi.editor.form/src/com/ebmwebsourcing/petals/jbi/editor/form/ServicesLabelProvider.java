...
public class ServicesLabelProvider extends LabelProvider {
	...
	public ServicesLabelProvider() {
		...
		this.saImgDesc = JbiFormEditorPlugin.getImageDescriptor( "icons/obj16/service_assembly.png" );
		this.suImgDesc = JbiFormEditorPlugin.getImageDescriptor( "icons/obj16/service_unit.png" );
	}
