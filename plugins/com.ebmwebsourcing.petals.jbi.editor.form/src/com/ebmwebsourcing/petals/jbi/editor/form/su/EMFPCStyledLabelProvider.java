...
implements IStyledLabelProvider {
	...
	public EMFPCStyledLabelProvider( Control control, Mep filteringMep ) {
		...
		this.providesDesc = JbiFormEditorPlugin.getImageDescriptor( "icons/obj16/provides_3.0.png" );
		this.consumesDesc = JbiFormEditorPlugin.getImageDescriptor( "icons/obj16/consumes_3.0.png" );
	}
