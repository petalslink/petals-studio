 ...
 * <!-- end-user-doc -->
 * @see com.ebmwebsourcing.petals.services.validation.validation.ValidationPackage
 * @generated
 */
public class ValidationSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ValidationPackage.VALIDATION_PROVIDES: {
				ValidationProvides validationProvides = (ValidationProvides)theEObject;
				T result = caseValidationProvides(validationProvides);
				if (result == null) result = caseProvides(validationProvides);
				if (result == null) result = caseAbstractEndpoint(validationProvides);
				if (result == null) result = caseAbstractExtensibleElement(validationProvides);
	 ...
	 * @generated
	 */
	public T caseValidationProvides(ValidationProvides object) {
		return null;
	}
