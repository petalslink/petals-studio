...
public class ValidationAdapterFactory extends AdapterFactoryImpl {
	...
	protected ValidationSwitch<Adapter> modelSwitch =
		new ValidationSwitch<Adapter>() {
			@Override
			public Adapter caseValidationProvides(ValidationProvides object) {
				return createValidationProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.validation.validation.ValidationProvides <em>Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createValidationProvidesAdapter() {
		return null;
	}
