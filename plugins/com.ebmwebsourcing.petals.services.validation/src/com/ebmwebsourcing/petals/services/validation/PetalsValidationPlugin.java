 ...
 */
public class PetalsValidationPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.validation";

	// The shared instance
	private static PetalsValidationPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsValidationPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsValidationPlugin getDefault() {
		return plugin;
	}
