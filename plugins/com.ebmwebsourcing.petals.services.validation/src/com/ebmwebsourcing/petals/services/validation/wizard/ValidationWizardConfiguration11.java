 ...
 */
public class ValidationWizardConfiguration11 extends WizardConfiguration {

	/**
	 * The constructor which overrides the configuration values.
	 */
	public ValidationWizardConfiguration11 () {

		this.wizardSettings.put( SettingConstants.WSDL_SHOW, "false" );
		this.wizardSettings.put( SettingConstants.ITF_NAME_VALUE, "ValidationInterface" );
		...
		this.wizardSettings.put( SettingConstants.ITF_NS_VALUE, "http://petals.ow2.org/components/validation/version-1" );
		this.wizardSettings.put( SettingConstants.SRV_NS_VALUE, "http://petals.ow2.org/components/validation/version-1" );
	}
}
