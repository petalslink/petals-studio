 ...
 * @generated
 */
public class Ftp3FactoryImpl extends EFactoryImpl implements Ftp3Factory {
	/**
	 ...
	 * @generated
	 */
	public static Ftp3Factory init() {
		try {
			Ftp3Factory theFtp3Factory = (Ftp3Factory)EPackage.Registry.INSTANCE.getEFactory("http://petals.ow2.org/components/ftp/version-3"); 
			if (theFtp3Factory != null) {
				return theFtp3Factory;
			}
		}
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case Ftp3Package.FTP_PROVIDES: return createFtpProvides();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case Ftp3Package.CONNECTION_TYPE:
				return createConnectionTypeFromString(eDataType, initialValue);
			case Ftp3Package.TRANSFER_TYPE:
	 ...
	 * @generated
	 */
	public FtpProvides createFtpProvides() {
		FtpProvidesImpl ftpProvides = new FtpProvidesImpl();
		return ftpProvides;
	}
	 ...
	 * @generated
	 */
	public Ftp3Package getFtp3Package() {
		return (Ftp3Package)getEPackage();
	}
	 ...
	 */
	@Deprecated
	public static Ftp3Package getPackage() {
		return Ftp3Package.eINSTANCE;
	}
