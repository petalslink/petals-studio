...
public class SqlAdapterFactory extends AdapterFactoryImpl {
	...
	protected SqlSwitch<Adapter> modelSwitch =
		new SqlSwitch<Adapter>() {
			@Override
			public Adapter caseSqlProvides(SqlProvides object) {
				return createSqlProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.sql.sql.SqlProvides <em>Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createSqlProvidesAdapter() {
		return null;
	}
