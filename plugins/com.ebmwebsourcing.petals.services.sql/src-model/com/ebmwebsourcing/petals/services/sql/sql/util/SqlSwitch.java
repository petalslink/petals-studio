...
package com.ebmwebsourcing.petals.services.sql.sql.util;
...
public class SqlSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SqlPackage.SQL_PROVIDES: {
				SqlProvides sqlProvides = (SqlProvides)theEObject;
				T result = caseSqlProvides(sqlProvides);
				if (result == null) result = caseProvides(sqlProvides);
				if (result == null) result = caseAbstractEndpoint(sqlProvides);
				if (result == null) result = caseAbstractExtensibleElement(sqlProvides);
	 ...
	 * @generated
	 */
	public T caseSqlProvides(SqlProvides object) {
		return null;
	}
