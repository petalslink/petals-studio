 ...
 *
 */
public class SqlProvidesEditorContribution implements JbiEditorDetailsContribution {
	...
	public void addAdvancedSUContent(AbstractEndpoint endpoint, FormToolkit toolkit, Composite advancedTab, ISharedEdition ise) {
...

		{
			...
			JBIEndpointUIHelpers.createDefaultWidgetsByEIntrospection(endpoint, toolkit, ejbComposite, ise, SqlPackage.Literals.SQL_PROVIDES);
		}
		{
