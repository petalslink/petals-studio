 ...
 */
public class SqlContributorDescription extends SuContributorDescription {
	...
	public String getProvideDescription() {
		return "Create a Petals service to execute SQL requests on a database.";
	}
	...
	public PetalsUseCase[] getUsesCases() {
		return new PetalsUseCase[] { PetalsUseCase.integration, PetalsUseCase.miscellaneous, PetalsUseCase.communication };
	}
}
