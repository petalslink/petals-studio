...
public class EJBCustomSpecificationPage12 extends AbstractSuPage {
	...
	public boolean validate() {
		...
		if( error == null ) {
			...
			settings.put( SettingConstants.SRV_NAME_VALUE, simpleName );
			settings.put( SettingConstants.EDPT_NAME_VALUE, simpleName + "Port" );
			settings.put( SettingConstants.ITF_NAME_VALUE, simpleName + "PortType" );
			...
			settings.put( SettingConstants.SRV_NS_VALUE, ns.toString());
			settings.put( SettingConstants.ITF_NS_VALUE, ns.toString());
		}
	...
	public void fillInData( EclipseSuBean suBean ) {
		...
		suBean.setEndpointName( settings.get( SettingConstants.EDPT_NAME_VALUE ));

		suBean.setInterfaceName( settings.get( SettingConstants.ITF_NAME_VALUE ));
		suBean.setInterfaceNamespaceUri( settings.get( SettingConstants.ITF_NS_VALUE ));

		suBean.setServiceName( settings.get( SettingConstants.SRV_NAME_VALUE ));
		suBean.setServiceNamespaceUri( settings.get( SettingConstants.SRV_NS_VALUE ));
	}
