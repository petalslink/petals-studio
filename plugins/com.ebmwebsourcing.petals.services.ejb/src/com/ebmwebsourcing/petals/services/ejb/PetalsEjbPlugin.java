 ...
 */
public class PetalsEjbPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.ejb";

	// The shared instance
	private static PetalsEjbPlugin plugin;


	/**
	 * The constructor
	 */
	public PetalsEjbPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsEjbPlugin getDefault() {
		return plugin;
	}
