...
public class EjbAdapterFactory extends AdapterFactoryImpl {
	...
	protected EjbSwitch<Adapter> modelSwitch =
		new EjbSwitch<Adapter>() {
			@Override
			public Adapter caseEjbProvides(EjbProvides object) {
				return createEjbProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.ejb.ejb.EjbProvides <em>Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createEjbProvidesAdapter() {
		return null;
	}
