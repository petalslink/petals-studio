 ...
 */
package com.ebmwebsourcing.petals.services.ejb.ejb.util;
 ...
 * <!-- end-user-doc -->
 * @see com.ebmwebsourcing.petals.services.ejb.ejb.EjbPackage
 * @generated
 */
public class EjbSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EjbPackage.EJB_PROVIDES: {
				EjbProvides ejbProvides = (EjbProvides)theEObject;
				T result = caseEjbProvides(ejbProvides);
				if (result == null) result = caseProvides(ejbProvides);
				if (result == null) result = caseAbstractEndpoint(ejbProvides);
				if (result == null) result = caseAbstractExtensibleElement(ejbProvides);
	 ...
	 * @generated
	 */
	public T caseEjbProvides(EjbProvides object) {
		return null;
	}
