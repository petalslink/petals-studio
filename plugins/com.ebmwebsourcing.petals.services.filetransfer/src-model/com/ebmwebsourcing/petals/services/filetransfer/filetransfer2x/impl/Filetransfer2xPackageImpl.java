...
public class Filetransfer2xPackageImpl extends EPackageImpl implements Filetransfer2xPackage {
	...
	public void initializePackageContents() {
		...
		fileTransferProvidesEClass.getESuperTypes().add(this.getFileTransferExtension());
		fileTransferConsumesEClass.getESuperTypes().add(theJbiPackage.getConsumes());
		fileTransferConsumesEClass.getESuperTypes().add(this.getFileTransferExtension());
		...
		initEAttribute(getFileTransferProvides_ReadDirectory(), ecorePackage.getEString(), "readDirectory", null, 0, 1, FileTransferProvides.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
