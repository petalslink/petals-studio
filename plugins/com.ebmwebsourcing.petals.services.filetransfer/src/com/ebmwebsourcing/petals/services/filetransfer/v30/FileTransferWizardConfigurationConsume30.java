 ...
 */
public class FileTransferWizardConfigurationConsume30 extends WizardConfiguration {

	/**
	 * The constructor which overrides the configuration values.
	 */
	public FileTransferWizardConfigurationConsume30 () {
		this.wizardSettings.put( SettingConstants.SUPPORTED_MEP, "InOnly" );
		addHciItem( "filetransfer:base-message", null, null, "<![CDATA[   ]]>", false );
	}
}
