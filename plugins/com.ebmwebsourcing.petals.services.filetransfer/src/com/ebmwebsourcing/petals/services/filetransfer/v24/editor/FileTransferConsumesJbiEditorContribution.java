...
public class FileTransferConsumesJbiEditorContribution implements JbiEditorDetailsContribution {
	...
	public void addAdvancedSUContent(AbstractEndpoint endpoint, FormToolkit toolkit, Composite advancedTab, ISharedEdition ise) {
		...
		JBIEndpointUIHelpers.createDefaultWidgetsByEIntrospection(endpoint, toolkit, ftComposite, ise, FileTransferPackage.Literals.FILE_TRANSFER_CONSUMES, FileTransferPackage.Literals.FILE_TRANSFER_EXTENSION);
