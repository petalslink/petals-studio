 ...
 */
package com.ebmwebsourcing.petals.services.quartz.quartz.util;
...
public class QuartzAdapterFactory extends AdapterFactoryImpl {
	...
	protected QuartzSwitch<Adapter> modelSwitch =
		new QuartzSwitch<Adapter>() {
			@Override
			public Adapter caseQuartzConsumes(QuartzConsumes object) {
				return createQuartzConsumesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.quartz.quartz.QuartzConsumes <em>Consumes</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createQuartzConsumesAdapter() {
		return null;
	}
