...
public class QuartzSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case QuartzPackage.QUARTZ_CONSUMES: {
				QuartzConsumes quartzConsumes = (QuartzConsumes)theEObject;
				T result = caseQuartzConsumes(quartzConsumes);
				if (result == null) result = caseConsumer(quartzConsumes);
	 ...
	 * @generated
	 */
	public T caseQuartzConsumes(QuartzConsumes object) {
		return null;
	}
