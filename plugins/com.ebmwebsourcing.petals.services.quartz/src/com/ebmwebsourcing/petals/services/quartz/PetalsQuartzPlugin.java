...
public class PetalsQuartzPlugin extends AbstractUIPlugin {
	...
	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.quartz";

	// The shared instance
	private static PetalsQuartzPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsQuartzPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsQuartzPlugin getDefault() {
		return plugin;
	}
