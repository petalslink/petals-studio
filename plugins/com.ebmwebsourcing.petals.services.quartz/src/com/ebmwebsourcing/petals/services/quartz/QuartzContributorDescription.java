 ...
 */
public class QuartzContributorDescription extends SuContributorDescription {
	...
	public PetalsUseCase[] getUsesCases() {
		return new PetalsUseCase[] { PetalsUseCase.integration, PetalsUseCase.soa, PetalsUseCase.miscellaneous };
	}
}
