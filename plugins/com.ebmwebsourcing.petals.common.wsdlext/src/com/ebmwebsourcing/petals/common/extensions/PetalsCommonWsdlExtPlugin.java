...
package com.ebmwebsourcing.petals.common.extensions;
 ...
 */
public class PetalsCommonWsdlExtPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.common.wsdl-ext";

	// The shared instance
	private static PetalsCommonWsdlExtPlugin plugin;


	/**
	 * The constructor
	 */
	public PetalsCommonWsdlExtPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsCommonWsdlExtPlugin getDefault() {
		return plugin;
	}
