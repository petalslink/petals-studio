 ...
 */
public class PetalsCdkPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.cdk";

	// The shared instance
	private static PetalsCdkPlugin plugin;


	/**
	 * The constructor
	 */
	public PetalsCdkPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsCdkPlugin getDefault() {
		return plugin;
	}
