 ...
 */
public class PetalsSoapPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.soap";

	// The shared instance
	private static PetalsSoapPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsSoapPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsSoapPlugin getDefault() {
		return plugin;
	}
