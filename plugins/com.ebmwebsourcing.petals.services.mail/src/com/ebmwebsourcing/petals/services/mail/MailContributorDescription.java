 ...
 */
public class MailContributorDescription extends SuContributorDescription {
	...
	public String getConsumeDescription() {
		return "Define an email-box poller that will invoke a Petals service on email reception.";
	}
