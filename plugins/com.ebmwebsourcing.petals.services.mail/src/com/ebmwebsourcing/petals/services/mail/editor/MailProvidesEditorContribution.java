 ...
 *
 */
public class MailProvidesEditorContribution implements JbiEditorDetailsContribution {
	...
	public void addAdvancedSUContent(AbstractEndpoint endpoint, FormToolkit toolkit, Composite advancedTab, ISharedEdition ise) {
...

		{
			...
			JBIEndpointUIHelpers.createDefaultWidgetsByEIntrospection(endpoint, toolkit, ejbComposite, ise, MailPackage.Literals.MAIL_PROVIDES);
		}
		{
