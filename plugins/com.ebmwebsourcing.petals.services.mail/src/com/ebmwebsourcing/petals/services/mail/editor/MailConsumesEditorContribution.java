 ...
 *
 */
public class MailConsumesEditorContribution implements JbiEditorDetailsContribution {
	...
	public void addAdvancedSUContent(AbstractEndpoint endpoint, FormToolkit toolkit, Composite advancedTab, ISharedEdition ise) {
		...
		JBIEndpointUIHelpers.createDefaultWidgetsByEIntrospection(endpoint, toolkit, componentComposite, ise, MailPackage.Literals.MAIL_CONSUMES);
