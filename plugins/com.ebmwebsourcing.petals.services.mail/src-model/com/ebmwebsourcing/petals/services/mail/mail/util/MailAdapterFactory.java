...
public class MailAdapterFactory extends AdapterFactoryImpl {
	...
	protected MailSwitch<Adapter> modelSwitch =
		new MailSwitch<Adapter>() {
			@Override
			public Adapter caseMailProvides(MailProvides object) {
				return createMailProvidesAdapter();
			}
			@Override
			public Adapter caseMailConsumes(MailConsumes object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.mail.mail.MailProvides <em>Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createMailProvidesAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.mail.mail.MailConsumes <em>Consumes</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
