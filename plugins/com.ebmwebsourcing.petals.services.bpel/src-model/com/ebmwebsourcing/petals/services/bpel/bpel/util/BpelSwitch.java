...
public class BpelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BpelPackage.BPEL_PROVIDES: {
				BPELProvides bpelProvides = (BPELProvides)theEObject;
				T result = caseBPELProvides(bpelProvides);
				if (result == null) result = caseProvides(bpelProvides);
				if (result == null) result = caseAbstractEndpoint(bpelProvides);
				if (result == null) result = caseAbstractExtensibleElement(bpelProvides);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>BPEL Provides</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>BPEL Provides</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseBPELProvides(BPELProvides object) {
		return null;
	}
