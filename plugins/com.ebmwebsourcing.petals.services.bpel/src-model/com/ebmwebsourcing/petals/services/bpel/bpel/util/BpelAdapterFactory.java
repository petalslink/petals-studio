...
public class BpelAdapterFactory extends AdapterFactoryImpl {
	...
	protected BpelSwitch<Adapter> modelSwitch =
		new BpelSwitch<Adapter>() {
			@Override
			public Adapter caseBPELProvides(BPELProvides object) {
				return createBPELProvidesAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.ebmwebsourcing.petals.services.bpel.bpel.BPELProvides <em>BPEL Provides</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createBPELProvidesAdapter() {
		return null;
	}
