 ...
 */
public class PetalsStudioDevPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.studio.dev.properties";

	// The shared instance
	private static PetalsStudioDevPlugin plugin;


	/**
	 * The constructor
	 */
	public PetalsStudioDevPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsStudioDevPlugin getDefault() {
		return plugin;
	}
