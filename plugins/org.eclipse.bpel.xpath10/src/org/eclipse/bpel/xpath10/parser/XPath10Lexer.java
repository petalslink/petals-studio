...
public class XPath10Lexer extends Lexer {
		...
		try {
			...
			if ( LA5_0=='\'' ) {
				...
				NoViableAltException nvae =
					new NoViableAltException("505:1: LITERAL : ( SINGLE_QUOTE_STRING | DOUBLE_QUOTE_STRING );", 5, 0, this.input);
	...
	public final void mNUMBER() throws RecognitionException {
		try {
			...
			if ( LA7_0>='0' && LA7_0<='9' ) {
				...
				NoViableAltException nvae =
					new NoViableAltException("507:1: NUMBER : ( ( DIGITS ) ( '.' DIGITS )? | '.' DIGITS );", 7, 0, this.input);
	...
	public final void mIDENTIFIER() throws RecognitionException {
		try {
			...
			{
				if ( this.input.LA(1)>='A' && this.input.LA(1)<='Z'||this.input.LA(1)=='_'||this.input.LA(1)>='a' && this.input.LA(1)<='z'||this.input.LA(1)>='\u0241' && this.input.LA(1)<='\u0377' ) {
					this.input.consume();
				...
				loop8:
					do {
						...
						case 1 :
							// XPath10__.g:
						{
							if ( this.input.LA(1)>='-' && this.input.LA(1)<='.'||this.input.LA(1)>='0' && this.input.LA(1)<='9'||this.input.LA(1)>='A' && this.input.LA(1)<='Z'||this.input.LA(1)=='_'||this.input.LA(1)>='a' && this.input.LA(1)<='z'||this.input.LA(1)>='\u0241' && this.input.LA(1)<='\u0377' ) {
								this.input.consume();
	...
	public void mTokens() throws RecognitionException {
		...
		if ( LA9_0=='o' ) {
			...
			if ( LA9_2=='n' ) {
				int LA9_28 = this.input.LA(3);

				if ( LA9_28=='d' ) {
					int LA9_42 = this.input.LA(4);
			...
			if ( LA9_3=='o' ) {
				int LA9_29 = this.input.LA(3);

				if ( LA9_29=='d' ) {
					int LA9_43 = this.input.LA(4);
			...
			if ( LA9_4=='i' ) {
				int LA9_30 = this.input.LA(3);

				if ( LA9_30=='v' ) {
					int LA9_44 = this.input.LA(4);
			...
			NoViableAltException nvae =
				new NoViableAltException("1:1: Tokens : ( OR | AND | MOD | DIV | LPAREN | RPAREN | LBRACKET | RBRACKET | PIPE | DOT | DOT2 | AT | COMMA | COLON2 | COLON | SLASH | SLASH2 | DOLLAR | PLUS | MINUS | EQ | NE | LT | LTE | GT | GTE | STAR | WS | LITERAL | NUMBER | IDENTIFIER );", 9, 0, this.input);
