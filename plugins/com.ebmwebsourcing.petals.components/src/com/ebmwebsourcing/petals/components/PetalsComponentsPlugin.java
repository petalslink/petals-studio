...
package com.ebmwebsourcing.petals.components;
 ...
 */
public class PetalsComponentsPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.components";

	// The shared instance
	private static PetalsComponentsPlugin plugin;


	/**
	 * The constructor
	 */
	public PetalsComponentsPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsComponentsPlugin getDefault() {
		return plugin;
	}
