	...
	ILabeledElement, IContentProposal, IStatefullAdapter
{
	...
	public Image getSmallImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_PARTNERLINKTYPE_16);
	}
	
	public Image getLargeImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_PARTNERLINKTYPE_32);
	}	
