	...
	IOutlineEditPartFactory, EditPartFactory, IEditPartActionContributor
{
	...
	public Image getSmallImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_FAULTHANDLER_16);
	}

	public Image getLargeImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_FAULTHANDLER_32);
	}	
