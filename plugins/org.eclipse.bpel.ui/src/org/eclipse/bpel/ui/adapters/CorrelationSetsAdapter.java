	...
	ILabeledElement, IOutlineEditPartFactory, ITrayEditPartFactory
{
	...
	public Image getSmallImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_CORRELATIONSET_16);
	}
	
	public Image getLargeImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_CORRELATIONSET_32);
	}	
