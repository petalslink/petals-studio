	...
	IOutlineEditPartFactory, EditPartFactory
{
	...
	public Image getSmallImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_TERMINATIONHANDLER_16);
	}

	public Image getLargeImage(Object object) {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_TERMINATIONHANDLER_32);
	}
