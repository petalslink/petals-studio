...
public class CreateProcessFaultHandlerAction implements IEditPartAction {
	...
	public Image getIconImg() {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_ACTION_FAULTHANDLER);
	}

	public ImageDescriptor getIcon() {
		return BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.ICON_ACTION_FAULTHANDLER);
	}
