...
public class CreateProcessEventHandlerAction implements IEditPartAction {
	...
	public ImageDescriptor getIcon() {
		return BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.ICON_ACTION_EVENTHANDLER);
	}

	public Image getIconImg() {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_ACTION_EVENTHANDLER);
	}
