...
public class SetCompensateLinkAction extends AbstractAction {
	...
	public ImageDescriptor getIcon() {
		return BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.ICON_ACTION_COMPENSATE);
	}

	public Image getIconImg() {
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_ACTION_COMPENSATE);
	}
