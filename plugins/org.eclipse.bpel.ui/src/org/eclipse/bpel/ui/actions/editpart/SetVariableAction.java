...
public class SetVariableAction extends AbstractAction {
	...
	public Image getIconImg() {
		if (type == RESPONSE) {
			return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_ACTION_OUTGOING);
		}
		return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_ACTION_INCOMING);
	}

	public ImageDescriptor getIcon() {
		if (type == RESPONSE) {
			return BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.ICON_ACTION_OUTGOING);
		}
		return BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.ICON_ACTION_INCOMING);
	}
