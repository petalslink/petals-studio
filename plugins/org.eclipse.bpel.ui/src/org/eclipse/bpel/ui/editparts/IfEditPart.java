...
public class IfEditPart extends PickEditPart {
	 ...
	 */
	private static class IfNodeEditPart extends ElseIfEditPart{
	...
	private class IfOrderedLayoutEditPolicy extends BPELOrderedLayoutEditPolicy {
		...
		protected void eraseLayoutTargetFeedback(Request request) {
			EditPolicy policy = IfEditPart.this.ifEditPart
	...
	private class IfOrderedHorizontalLayoutEditPolicy extends IfEditPart.IfOrderedLayoutEditPolicy{
		...
		public void refreshConnections() {
			...
			if (!isCollapsed()) {
				this.polyLineConnectionList = createHorizontalConnections((BPELEditPart) getHost());
				this.polyLineConnectionList.addAll(createVerticalConnections(getIfNodeEditPart()));
			}
		}
