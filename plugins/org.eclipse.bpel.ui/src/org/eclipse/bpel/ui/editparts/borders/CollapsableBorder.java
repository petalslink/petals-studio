...
public abstract class CollapsableBorder extends GradientBorder {
	...
	public CollapsableBorder(boolean isVertical, int arcWidth, IFigure parentFigure, String labelText, Image image) {
		...
		this.collapsedImage = BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_FIGURE_COLLAPSED);
		this.expandedImage = BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_FIGURE_EXPANDED);
