...
public class BPELSelectionEditPolicy extends NonResizableEditPolicy {
	...
	public void eraseSourceFeedback(Request request) {
		if( request instanceof ChangeBoundsRequest
					&& this.fResizable && REQ_RESIZE.equals(request.getType()))
	...
	public boolean understandsRequest(Request request) {
		if (this.fResizable && REQ_RESIZE.equals(request.getType()))
			return true;
		...
		if (REQ_MOVE.equals(request.getType())) return this.fMovable;
	...
	protected void eraseChangeBoundsFeedback(ChangeBoundsRequest request) {
		if (REQ_MOVE.equals(request.getType()) && !this.fMovable)
			return;
