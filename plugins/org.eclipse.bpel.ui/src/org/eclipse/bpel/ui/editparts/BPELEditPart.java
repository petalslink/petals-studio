...
public abstract class BPELEditPart extends AbstractGraphicalEditPart implements IHoverHelperSupport {
	...
	protected void createEditPolicies() {
		...
		// Extensions
		for (IEditPolicyProvider provider : BPELUIRegistry.getInstance().getEditPolicyProviders()) {
			if (provider.appliesTo(this)) {
				for (Entry<Object, EditPolicy> providedPolicies : provider.getEditPolicies().entrySet()) {
					installEditPolicy(providedPolicies.getKey(), providedPolicies.getValue());
				}
			}
		}
	}
	...
	public void performDirectEdit() {
		if (getLabelFigure() != null) {
			...
			if (this.manager == null) {
				this.manager = new BPELDirectEditManager(this, TextCellEditor.class,
	...
	protected AccessibleEditPart getAccessibleEditPart() {
		if (this.acc == null) this.acc = createAccessible();
		return this.acc;
	}
	...
	protected BPELEditPartMarkerDecorator.MarkerMotionListener getMarkerMotionListener() {
		return this.markerMotionListener = new BPELEditPartMarkerDecorator.MarkerMotionListener() {
