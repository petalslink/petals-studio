...
public class BPELTrayAccessibleEditPart extends TrayAccessibleEditPart {
	...
	public void getName(AccessibleEvent e) {
		...
		ILabeledElement labeledElement = BPELUtil.adapt(this.part.getModel(), ILabeledElement.class);

		if (labeledElement != null) {
			childType = labeledElement.getTypeLabel(this.part.getModel());
			displayName = labeledElement.getLabel(this.part.getModel());
