...
public class InvokeEditPart extends LeafEditPart implements ILayoutAware{
	...
	protected IFigure createFigure() {
		if (this.image == null) {
			...
			this.image = element.getSmallImage(getActivity());
		}
		...
		gradient.setForegroundColor(BPELUIPlugin.getDefault().getColorRegistry().get(IBPELUIConstants.COLOR_BLACK));
		gradient.add(this.imageLabel);
		gradient.add(this.nameLabel);
		...
		this.border.setShowFault(getFaultHandler() != null);
		this.border.setShowCompensation(getCompensationHandler() != null);
		gradient.setBorder(this.border);
