...
public class PickEditPart extends SequenceEditPart {
	...
	private static class PickOrderedLayoutEditPolicy extends BPELOrderedLayoutEditPolicy{
		@Override
	...
	protected IFigure getNewContentPane(Layer layer) {
		CollapsablePickContainerFigure fig =  new CollapsablePickContainerFigure(getModel(), this.image, getLabel());
