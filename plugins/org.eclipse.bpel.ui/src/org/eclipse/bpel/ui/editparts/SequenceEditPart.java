...
public class SequenceEditPart extends CollapsableEditPart {
	...
	private static class SequenceHorizontalBPELOrderedLayoutPolicy extends BPELOrderedLayoutEditPolicy{
		@Override
				...
				for (int i = 0; i < children.size(); i++) {
					...
					if (sourceAnchor != null && targetAnchor != null) {
						PolylineConnection connection = createConnection(
									sourceAnchor, targetAnchor, this.arrowColor);
