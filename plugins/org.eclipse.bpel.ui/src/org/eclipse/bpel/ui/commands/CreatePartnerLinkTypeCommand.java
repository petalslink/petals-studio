...
public class CreatePartnerLinkTypeCommand extends CreateWSDLExtensibilityElementCommand {
	...
	public void doExecute() {
		...
		if (this.partner != null) {
			getPartnerLinkType().setName(BPELUtil.getUniqueModelName(this.definition, this.partner.getName() + "PLT", Collections.singletonList(getPartnerLinkType()))); //$NON-NLS-1$
		}
	...
	protected PartnerLinkType getPartnerLinkType() {
		return (PartnerLinkType)this.element;
	}
}
