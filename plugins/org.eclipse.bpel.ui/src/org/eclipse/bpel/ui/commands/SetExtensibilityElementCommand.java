...
public class SetExtensibilityElementCommand extends AutoUndoCommand {
	...
	protected void initValues() {
		...
		this.oldExtension = ModelHelper.getExtensibilityElement(this.target, this.clazz);
	...
	public void doExecute() {
		...
		if (this.newExtension != null) this.target.getEExtensibilityElements().add(this.newExtension);
	}
}
