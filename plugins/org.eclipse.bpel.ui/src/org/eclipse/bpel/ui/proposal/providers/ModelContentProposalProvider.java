...
IContentProposalProvider {
	...
	private final List<IContentProposal> fEndProposals = new ArrayList<IContentProposal>();
	private final List<IContentProposal> fStartProposals = new LinkedList<IContentProposal>();
	...
	public IContentProposal[] getProposals (String contents, int position) {
		...
		IContentProposal[] proposals = (IContentProposal[]) ListMap.Map (
					...
					doFilter(  this.contentProvider.getElements( this.valueProvider.value())),
