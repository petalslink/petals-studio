...
public class ScrollingBPELGraphicalViewer extends GraphicalViewerImpl {
	...
	public class NumeratorVisitor implements IModelVisitor {
		public boolean visit(Object modelObject) {
			...
			ScrollingBPELGraphicalViewer.this.orderMap.put(modelObject, Integer.valueOf( ScrollingBPELGraphicalViewer.this.indexVisit ));
			return true;
		}
	}
	...
	private class OrderedSelectionComparator implements Comparator {
		public int compare(Object o1, Object o2) {
			...
			if (ScrollingBPELGraphicalViewer.this.orderMap.get(m1) != null)
				val1 = (ScrollingBPELGraphicalViewer.this.orderMap.get(m1)).intValue();
			if (ScrollingBPELGraphicalViewer.this.orderMap.get(m2) != null)
				val2 = (ScrollingBPELGraphicalViewer.this.orderMap.get(m2)).intValue();
			if (val1 < val2)
				return -1;
			else
				if (val1 > val2)
	...
	public void appendSelection(EditPart editpart) {
		...
		if (this.selectionList.size() > 1){
			this.indexVisit = 0;
			this.orderMap = new HashMap<Object, Integer>();
