...
public class SeparatorContentProvider extends AbstractContentProvider {
	...
	public static class Separator implements IContentProposal , ILabelProvider, ILabeledElement {
		...
		public Image getImage(Object element) {
			return BPELUIPlugin.getDefault().getImage(IBPELUIConstants.ICON_SEPARATOR_16);
		}
