...
public class PartnerLinkExtensionImpl extends EObjectImpl implements PartnerLinkExtension {
	...
	public void setPartnerKind(int newPartnerKind) {
		int oldPartnerKind = this.partnerKind;
		this.partnerKind = newPartnerKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.PARTNER_LINK_EXTENSION__PARTNER_KIND, oldPartnerKind, this.partnerKind));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UiextensionmodelPackage.PARTNER_LINK_EXTENSION__PARTNER_KIND:
			return this.partnerKind != PARTNER_KIND_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(this.partnerKind);
		result.append(')');
