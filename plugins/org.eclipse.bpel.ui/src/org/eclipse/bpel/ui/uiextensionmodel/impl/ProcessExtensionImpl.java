...
public class ProcessExtensionImpl extends EObjectImpl implements ProcessExtension {
	...
	public void setSpecCompliant(boolean newSpecCompliant) {
		boolean oldSpecCompliant = this.specCompliant;
		this.specCompliant = newSpecCompliant;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.PROCESS_EXTENSION__SPEC_COMPLIANT, oldSpecCompliant, this.specCompliant));
	}
	...
	public void setModificationStamp(long newModificationStamp) {
		long oldModificationStamp = this.modificationStamp;
		this.modificationStamp = newModificationStamp;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.PROCESS_EXTENSION__MODIFICATION_STAMP, oldModificationStamp, this.modificationStamp));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UiextensionmodelPackage.PROCESS_EXTENSION__SPEC_COMPLIANT:
			return this.specCompliant != SPEC_COMPLIANT_EDEFAULT;
		case UiextensionmodelPackage.PROCESS_EXTENSION__MODIFICATION_STAMP:
	...
	public String toString() {
		...
		result.append(this.specCompliant);
		result.append(", modificationStamp: ");
		result.append(this.modificationStamp);
		result.append(')');
