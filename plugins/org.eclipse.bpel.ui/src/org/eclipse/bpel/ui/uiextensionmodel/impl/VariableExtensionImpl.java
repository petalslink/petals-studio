...
public class VariableExtensionImpl extends EObjectImpl implements VariableExtension {
	...
	public void setAdvancedKind(int newAdvancedKind) {
		int oldAdvancedKind = this.advancedKind;
		this.advancedKind = newAdvancedKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.VARIABLE_EXTENSION__ADVANCED_KIND, oldAdvancedKind, this.advancedKind));
	}
	...
	public void setVariableKind(int newVariableKind) {
		int oldVariableKind = this.variableKind;
		this.variableKind = newVariableKind;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.VARIABLE_EXTENSION__VARIABLE_KIND, oldVariableKind, this.variableKind));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UiextensionmodelPackage.VARIABLE_EXTENSION__ADVANCED_KIND:
			return this.advancedKind != ADVANCED_KIND_EDEFAULT;
		case UiextensionmodelPackage.VARIABLE_EXTENSION__VARIABLE_KIND:
			return this.variableKind != VARIABLE_KIND_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(this.advancedKind);
		result.append(", variableKind: ");
		result.append(this.variableKind);
		result.append(')');
