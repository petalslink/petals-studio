...
public class CopyExtensionImpl extends EObjectImpl implements CopyExtension {
	...
	public void setFromType(int newFromType) {
		int oldFromType = this.fromType;
		this.fromType = newFromType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.COPY_EXTENSION__FROM_TYPE, oldFromType, this.fromType));
	}
	...
	public void setToType(int newToType) {
		int oldToType = this.toType;
		this.toType = newToType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiextensionmodelPackage.COPY_EXTENSION__TO_TYPE, oldToType, this.toType));
	}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case UiextensionmodelPackage.COPY_EXTENSION__FROM_TYPE:
			return this.fromType != FROM_TYPE_EDEFAULT;
		case UiextensionmodelPackage.COPY_EXTENSION__TO_TYPE:
			return this.toType != TO_TYPE_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(this.fromType);
		result.append(", toType: ");
		result.append(this.toType);
		result.append(')');
