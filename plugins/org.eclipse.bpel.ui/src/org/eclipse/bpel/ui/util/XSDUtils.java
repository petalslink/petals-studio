...
public class XSDUtils {
	 ...
	 * @return
	 */
	public static XSDAnnotation addDocumentationAndAttributes(XSDConcreteComponent component, String text, Map<String,String> attributes)
	{
		if (null == component)
		{
		...
		for( Map.Entry<String,String> entry : attributes.entrySet())
			userInfo.setAttribute( entry.getKey(), entry.getValue());
	...
	public static List<XSDTypeDefinition> getAdvancedPrimitives() {
		...
		List<XSDTypeDefinition> advancedPrimitives = new ArrayList<XSDTypeDefinition>();
	...
	public static String getDocumentation(XSDFeature element) {
		...
		if(annotation != null) {
			for( Object element2 : annotation.getUserInformation() ) {
				Element domElement = (Element) element2;
	...
	public static List<XSDSimpleTypeDefinition> getPrimitives() {
		...
		List<XSDSimpleTypeDefinition> primitives = new ArrayList<XSDSimpleTypeDefinition>();
		...
		// Return primitives in alpha order
		Collections.sort(primitives, new Comparator<XSDSimpleTypeDefinition>() {

			public int compare(XSDSimpleTypeDefinition o1, XSDSimpleTypeDefinition o2) {
				if(o1 == null || o2 == null || getDisplayNameFromXSDType( o1 ) == null)
					return 0;
				return getDisplayNameFromXSDType( o1 ).compareTo( getDisplayNameFromXSDType( o2 ));
			}
		});
	...
	public static Collection<XSDComplexTypeDefinition> getReferencedTypes(XSDComplexTypeDefinition source) {
		...
		for( XSDFeature element : getChildElements(source) ) {
	...
	public static Collection<XSDTypeDefinition> getAllReferencedTypes(XSDComplexTypeDefinition source, boolean includeAnonymous)
	{
		...
		for( XSDFeature next : getChildElements(source) ) {
