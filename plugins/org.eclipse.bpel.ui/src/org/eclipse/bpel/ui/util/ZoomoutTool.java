...
public class ZoomoutTool extends AbstractTool {
	...
	protected Cursor createCursor() {
		...
		ImageData source = BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.CURSOR_ZOOM_OUT).getImageData();
		ImageData mask = BPELUIPlugin.getDefault().getImageDescriptor(IBPELUIConstants.CURSOR_ZOOM_MASK).getImageData();
