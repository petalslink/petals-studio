 ...
 */
package com.ebmwebsourcing.petals.services.pojo.pojo.util;
...
public class PojoSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PojoPackage.POJO_PROVIDES: {
				PojoProvides pojoProvides = (PojoProvides)theEObject;
				T result = casePojoProvides(pojoProvides);
				if (result == null) result = caseProvides(pojoProvides);
				if (result == null) result = caseAbstractEndpoint(pojoProvides);
				if (result == null) result = caseAbstractExtensibleElement(pojoProvides);
	 ...
	 * @generated
	 */
	public T casePojoProvides(PojoProvides object) {
		return null;
	}
