 ...
 *
 */
public class PojoProvidesEditorContribution implements JbiEditorDetailsContribution {
	...
	public void addMainSUContent(final AbstractEndpoint endpoint, FormToolkit toolkit, final Composite mainTab, ISharedEdition ise) {
...

		{
			...
			JBIEndpointUIHelpers.createDefaultWidgetsByEIntrospection(endpoint, toolkit, ejbComposite, ise, PojoPackage.Literals.POJO_PROVIDES);
		}
