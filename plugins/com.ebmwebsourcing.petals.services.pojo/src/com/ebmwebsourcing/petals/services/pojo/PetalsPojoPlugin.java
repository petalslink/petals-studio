 ...
 */
public class PetalsPojoPlugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.pojo";

	// The shared instance
	private static PetalsPojoPlugin plugin;

	/**
	 * The constructor
	 */
	public PetalsPojoPlugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsPojoPlugin getDefault() {
		return plugin;
	}
