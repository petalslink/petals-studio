...
public class JmsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case JmsPackage.JMS_EXTENSION: {
				JmsExtension jmsExtension = (JmsExtension)theEObject;
				T result = caseJmsExtension(jmsExtension);
				if (result == null) result = caseAbstractExtensibleElement(jmsExtension);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JmsPackage.JMS_PROVIDES: {
				JmsProvides jmsProvides = (JmsProvides)theEObject;
				T result = caseJmsProvides(jmsProvides);
				if (result == null) result = caseJmsExtension(jmsProvides);
				if (result == null) result = caseAbstractExtensibleElement(jmsProvides);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case JmsPackage.JMS_CONSUMES: {
				JmsConsumes jmsConsumes = (JmsConsumes)theEObject;
				T result = caseJmsConsumes(jmsConsumes);
				if (result == null) result = caseJmsExtension(jmsConsumes);
				if (result == null) result = caseAbstractExtensibleElement(jmsConsumes);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseJmsExtension(JmsExtension object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseJmsProvides(JmsProvides object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseJmsConsumes(JmsConsumes object) {
		return null;
	}
