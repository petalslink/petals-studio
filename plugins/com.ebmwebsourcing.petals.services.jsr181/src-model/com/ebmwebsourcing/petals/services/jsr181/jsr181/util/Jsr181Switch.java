 ...
 * @generated
 */
public class Jsr181Switch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Jsr181Package.JSR181_PROVIDES: {
				Jsr181Provides jsr181Provides = (Jsr181Provides)theEObject;
				T result = caseJsr181Provides(jsr181Provides);
				if (result == null) result = caseProvides(jsr181Provides);
				if (result == null) result = caseAbstractEndpoint(jsr181Provides);
				if (result == null) result = caseAbstractExtensibleElement(jsr181Provides);
	 ...
	 * @generated
	 */
	public T caseJsr181Provides(Jsr181Provides object) {
		return null;
	}
