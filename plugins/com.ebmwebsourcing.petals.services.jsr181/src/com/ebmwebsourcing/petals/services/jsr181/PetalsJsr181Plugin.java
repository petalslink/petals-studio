 ...
 */
public class PetalsJsr181Plugin extends AbstractUIPlugin {

	// The plug-in ID
	public static final String PLUGIN_ID = "com.ebmwebsourcing.petals.services.jsr181";

	// The shared instance
	private static PetalsJsr181Plugin plugin;

	/**
	 * The constructor
	 */
	public PetalsJsr181Plugin() {
		// nothing
	}
	 ...
	 */
	public static PetalsJsr181Plugin getDefault() {
		return plugin;
	}
