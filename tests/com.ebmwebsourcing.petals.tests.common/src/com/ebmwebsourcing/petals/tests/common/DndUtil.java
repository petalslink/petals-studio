 ...
 *     Mickae Istria (PetalsLink) - Added support for GefEditParts
 *******************************************************************************/
...
public class DndUtil {
	...
	public void dragAndDrop(final AbstractSWTBot<? extends Widget> toDrag, SWTBotGefEditPart rootEditPart) {
		dragAndDrop(toDrag, Geometry.centerPoint(absoluteLocation(rootEditPart)));
	}
